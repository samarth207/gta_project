...
class Finder extends Component {
    ...
    createWall(r, c){
        if(this.state.mouseIsPressed === true && (r>=0 && r<25) && (c>=0 && c<41)){
        ...
        return (
            <div className = "finder my-2 ml-3">
                <div className = "parameter" style = {parameterCss}>
                    ...
                    <div  style={{ color: "#996560", fontSize: "17px", fontWeight: "600", padding: "5px 20px 0px 20px" }}>
                ...
                <div className="simulator" style={simulatorCss}>
                    ...
                    <div className="grid mx-5 my-3">
                        {grid.map((row, rowIdx) => {
                            return (
                                <div className = "row" key={rowIdx}>
                                    {row.map((node, nodeIdx) => {
                                        const { row, col, isWall} = node;
                                        const extraClassName = (row === this.state.finish_node_row && col === this.state.finish_node_col)
                                            ? 'node-finish'
                                        ...
                                        return (
                                            <div
                                                ...
                                                onMouseDown = {()=>this.setState({mouseIsPressed : true})}
                                                onMouseUp={() => this.setState({ mouseIsPressed: false })}
                                            >
                                            </div>
                                        );
                                    })}
